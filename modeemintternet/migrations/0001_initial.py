    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shell', models.CharField(default=b'/bin/bash', max_length=32, choices=[(b'/bin/sh', b'/bin/sh'), (b'/bin/bash', b'/bin/bash'), (b'/bin/zsh', b'/bin/zsh'), (b'/bin/tcsh', b'/bin/tcsh'), (b'/bin/false', b'/bin/false')])),
